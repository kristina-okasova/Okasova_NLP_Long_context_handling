...
class BaseExperiment(ABC):
    ...
    @abstractmethod
    def prepare_prompts(self) -> list[str | list[str]]:
        """
    ...
    @abstractmethod
    def prepare_multi_turn_prompts(self) -> list[str | list[str]]:
        """
    ...
    @abstractmethod
    def process_llm_outputs(self, llm_outputs_raw, enable_thinking=False) -> list[list[Any]] | None:
        """
